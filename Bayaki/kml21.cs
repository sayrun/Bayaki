...
public partial class LatLonBoxType : ObjectType {
    ...
    /// <remarks/>
    [System.ComponentModel.DefaultValueAttribute(180D)]
    public double north {
        get {
...
public abstract partial class OverlayType : FeatureType {
    ...
    /// <remarks/>
    // CODEGEN の警告: このバージョンの .NET Framework では、型 System.Byte[] のメンバーでの DefaultValue 属性の使用はサポートされていません。
    // CODEGEN の警告: 型が 'hexBinary' の項目の 'default' 属性は、このバージョンの .Net Framework ではサポートされていません。default='ffffffff' 属性を無視します。
...
public partial class BalloonStyleType : ObjectType {
    ...
    /// <remarks/>
    // CODEGEN の警告: このバージョンの .NET Framework では、型 System.Byte[] のメンバーでの DefaultValue 属性の使用はサポートされていません。
    // CODEGEN の警告: 型が 'hexBinary' の項目の 'default' 属性は、このバージョンの .Net Framework ではサポートされていません。default='ff000000' 属性を無視します。
    [System.Xml.Serialization.XmlElementAttribute(DataType="hexBinary")]
